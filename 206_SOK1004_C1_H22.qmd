...
Ut fra det vi ser på grafen så har BNP fått en økning på sirka 100%.
Forskjellen på løpende og faste priser er at løpende priser er når man tar utgangspunkt i de faktiske prisene det pågjeldende året, mens ved faste priser tar det høyde for inflasjon og endret pengeverdi.
Løpende priser er mest relevant når vi ser på for eksempel 
...
Forskjellen mellom "df" og "df_wide" er at "df_wide"lager flere kolonner samtidig som det lir færre rader.
...
Alle prikker under 0 er negativ vekst, og dette ser vi så tidlig som på 1980 tallet, og når  vi ser på det i nyere tider er det trolig grunnet Covid19.
